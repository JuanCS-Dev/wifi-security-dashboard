...
class Guardian(Character):
    ...
    def __init__(self):
        super().__init__(character_id="guardian", name="The Guardian", emoji="🛡️")
    ...
    def update_from_network_state(self, network_state: NetworkState) -> None:
        ...
        if network_state.signal_dbm != self.last_signal_dbm:
            if network_state.signal_dbm < -70 and self.last_signal_dbm >= -70:
                ...
                self.process_event("SIGNAL_STRONG", {"signal_dbm": network_state.signal_dbm})
        ...
        if network_state.rogue_aps_detected:
            self.process_event("ROGUE_AP_DETECTED", {"rogue_aps": network_state.rogue_aps_detected})
    ...
    def _on_signal_weak(self, event_data: Dict[str, Any]) -> None:
        ...
        self.speak(
            ...
            educational_note=(
                "WiFi signal below -70 dBm is considered weak. "
    ...
    def _on_encryption_changed(self, event_data: Dict[str, Any]) -> None:
        ...
        if new_armor == self.ARMOR_NONE:
            ...
            self.speak(
                ...
                educational_note=(
                    "Unencrypted WiFi (no password) is dangerous. "
                    "All your traffic is visible to anyone nearby."
                ),
                duration=5.0,
            )
            ...
            self.speak(
                ...
                educational_note=(
                    "WEP encryption is outdated and can be cracked in minutes. "
    ...
    def _on_rogue_ap(self, event_data: Dict[str, Any]) -> None:
        ...
        self.speak(
            ...
            educational_note=(
                ...
                "that impersonate legitimate ones to steal data."
            ),
            duration=5.0,
        )
    ...
    def _on_threat_cleared(self, event_data: Dict[str, Any]) -> None:
        ...
        self.transition_to(CharacterMood.HAPPY)
        self.speak("Threat neutralized! The kingdom is safe again.", duration=3.0)
    ...
    def on_update(self, dt: float) -> None:
        ...
        if self.mood == CharacterMood.IDLE:
            ...
            # Breathing animation (future: use for sprite rendering)
            _breath_cycle = math.sin(self.animation_timer * 2) * 0.1  # noqa: F841
